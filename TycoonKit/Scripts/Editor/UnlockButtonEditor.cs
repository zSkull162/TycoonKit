...
public class UnlockButtonEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (_script.editorOptions)
        {
            ...
            InspectorUtils.Description("These buttons assume your money manager is named exactly \"MoneyManager\", your audio source is named exactly \"ButtonAudio\", (capitalization and no space), and that the Container Object is the <i>first</i> child of the object with this script.");
            EditorGUILayout.Space(1);
            EditorGUILayout.BeginHorizontal();
            ...
            InspectorUtils.Description("Toggles the container object. Purely for the slight convenience. <color=grey><i>This button also assumes the Container Object is the first child of the object with this script.</i></color>");
            EditorGUILayout.Space(1);
            EditorGUILayout.BeginHorizontal();
            ...
            InspectorUtils.Description("This will rename the object with this script in the hierarchy to be like: \"(UnlockName) Unlock\"");
            EditorGUILayout.Space(1);
            EditorGUILayout.BeginHorizontal();
            ...
            if (GUILayout.Button("Undo name change"))
            {
